...
//Md implement
		<>
			<div className='flex flex-col md:items-center items-center m-0 p-0 md:w-full w-fit'>
				...
				<div className='flex md:text-6xl text-3xl font-bold md:m-10 mt-20 ' style={{ fontFamily: '"DynaPuff", system-ui' }}>
				...
				<div className='flex flex-col mt-10'>
						<input 
						className='flex md:place-items-center  md:text-6xl text-4xl font-bold place-items-center bg-white text-black border-2 border-black-700 md:h-20 h-10 md:w-screen w-screen md:mb-1 mb-1'
						type='text'
		...
		{/* <div className='flex  mt-4 '> */}
			<ul className='flex md:flex-wrap md:justify-center justify-center flex-wrap md:mt-10 mt-20 md:text-9xl text-5xl font-bold m-0 p-0 ' style={{ fontFamily: '"DynaPuff", system-ui' }}>
