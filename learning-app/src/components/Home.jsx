...
//Md implement
		<>
			<div className='flex flex-col lg:items-center md:items-center sm:items-center items-center m-0 p-0 lg:w-screen md:w-screen sm:w-screen min-w-screen'>
					<MenuBtn onClick={onBackClick}/>
				<div className='flex lg:text-6xl md:text-5xl sm:text-4xl text-3xl lg:w-fit md:w-fit sm:w-fit w-fit font-bold md:m-10 mt-20   ' style={{ fontFamily: '"DynaPuff", system-ui' }}>
