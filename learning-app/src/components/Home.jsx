...
//Md implement
		<>
			<div className='flex flex-col  place-items-center h-fit w-screen'>
					<MenuBtn onClick={onBackClick}/>
				<div className='flex lg:text-6xl md:text-5xl sm:text-4xl text-3xl w-fit font-bold md:m-10 mt-20' style={{ fontFamily: '"DynaPuff", system-ui' }}>
