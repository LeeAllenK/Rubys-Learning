export function Main({onNumberOneClick,onNumberTwoClick,onAlphabetClick}){
	...
	<>
			...
			<div className='flex m-0 flex-col items-center justify-start md:h-screen h-screen md:w-full w-screen md:text-6xl text-5xl font-black '>
				<button className='md:text-black-900 flex md:justify-center justify-center items-center lg:25 md:h-20 h-20 md:w-screen w-screen border-t-[0.09em] border-b-[0.09em] border-t-[#f0f0f0] border-b-[#a8a6a6] border-none bg-gradient-to-b from-[#f0f0f0] to-[#a8a6a6] shadow-[0_4px_3px_#a8a6a6] m-2 cursor-pointer mt-20 hover:bg-linear-[180deg,green_100%] hover:shadow-[0_4px_3px_008000] hover:text-white' style={{ fontFamily: '"DynaPuff", system-ui'}} onClick={onAlphabetClick}>Alphabets</button>
				<button className='text-black-900 flex justify-center items-center lg:25 md:h-20 h-20 sm:full md:w-screen  w-screen border-t-[0.09em] border-b-[0.09em] border-t-[#f0f0f0] border-b-[#a8a6a6] border-none bg-gradient-to-b from-[#f0f0f0] to-[#a8a6a6] shadow-[0_4px_3px_#a8a6a6] m-2 cursor-pointer hover:bg-linear-[180deg,green_100%] hover:shadow-[0_4px_3px_008000] hover:text-white' style={{ fontFamily: '"DynaPuff", system-ui' }} onClick={onNumberOneClick}>Numbers 1-10</button>
